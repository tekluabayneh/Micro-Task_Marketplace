  ...
  return (
    <section className="w-full h-96 grid justify-center">
      ...
      <div className="w-full grid grid-cols-1 xs:grid-cols-2 mx-auto sm:grid-cols-2 md:grid-cols-4 gap-5 justify-center">
        {ExploreOfferData.categories.map((item) => {
          return (
            <div className="w-48 h-24 flex flex-col gap-5  rounded-sm cursor-pointer shadow bg-[var(--gray-95)] hover:bg-[var(--gray-70)] p-1">
